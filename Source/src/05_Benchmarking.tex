...
In the context of this paper, we are going to purposely explore mainly techniques which can be applied to Unix-like operating systems. However, there are also techniques which can be applied to other types of devices. For example, in case the models need to be run on a mobile device, Tensorflow Lite provide benchmarking tools to measure inference time both in warming up and steady state. \cite{tensorflow2015-whitepaper}\\ 
