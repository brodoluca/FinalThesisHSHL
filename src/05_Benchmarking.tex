...
\]
Once the model has been trained for the respective number of epoch and the inference has been tested, the results are saved and the model initialized. The process end when the list ends. 
