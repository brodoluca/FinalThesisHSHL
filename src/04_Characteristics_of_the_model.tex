...
\section{Training Loss and Loss Function}
...
\cite{10.5555/525960}\cite{reed_neural_1999}
...
\begin{itemize}
\item validation loss >> training loss: overfitting
\item validation loss >training loss: some overfitting
\item validation loss < training loss: some underfitting
\item validation loss << training loss: underfitting
...
\cite{Nowlan1992SimplifyingNN}
\cite{overfitting}
\subsection{Regularization}
\url{https://programming-review.com/machine-learning/overfitting}
\section{Parameters}
