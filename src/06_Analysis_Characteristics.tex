...
A closer look to the list of slowest images reveals that there are pictures in common amongst all models (Fig. n. \ref{fig:slowest_files_all}). 
\section{Second Experiment}


\begin{figure}[h]
       \centering 
	    \includegraphics[width = 12 cm]{seedlings_100.png}
        \caption[Comparison between training time and accuracy for each model for 10 epochs]{Comparison between training time and accuracy for each model for 10 epochs. The x axis is the training time in seconds, while the y axis is the accuracy achieved}
...
\begin{figure}[h]
\centering
\begin{tabular}{ p{2cm} c p{4cm} cp{3cm}  }
 Model& Highest Accuracy (\%) & Epochs needed \\
 \hline
Resnet18&94.39&100\\
Resnet34&94.48&99\\
Resnet50&96.65&100\\
...
VGG19&95.20&96\\
 \hline
\end{tabular}
\caption[Highest accuracy achieved on the 'plant\_seedlings\_v2' dataset]{Highest accuracy achieved on the 'plant\_seedlings\_v2' dataset}
\label{fig:highest_accuracy}
\end{figure}
